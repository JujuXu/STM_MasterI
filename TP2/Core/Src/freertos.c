...
/* Definitions for announceOscarsT */
osThreadId_t announceOscarsTHandle;
const osThreadAttr_t announceOscarsT_attributes = {
  .name = "announceOscarsT",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow1,
};
/* Definitions for winnerAnnounceT */
osThreadId_t winnerAnnounceTHandle;
const osThreadAttr_t winnerAnnounceT_attributes = {
  .name = "winnerAnnounceT",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow1,
};
...
/* USER CODE BEGIN Header_announceOscars */
/**
* @brief Function implementing the announceOscarsT thread.
* @param argument: Not used
* @retval None
*/
...
void announceOscars(void *argument)
{
  ...
  /* USER CODE END announceOscars */
}

/* USER CODE BEGIN Header_winnerAnnounce */
/**
* @brief Function implementing the winnerAnnounceT thread.
* @param argument: Not used
* @retval None
*/
